...
; 0000 0028 DDRB=(0<<DDB7) | (0<<DDB6) | (1<<DDB5) | (0<<DDB4) | (0<<DDB3) | (0<<DDB2) | (0<<DDB1) | (0<<DDB0);
	LDI  R30,LOW(32)
	OUT  0x17,R30
...
; 0000 0036 PORTD=(0<<PORTD7) | (0<<PORTD6) | (0<<PORTD5) | (0<<PORTD4) | (0<<PORTD3) | (0<<PORTD2) | (0<<PORTD1) | (0<<PORTD0);
	OUT  0x12,R30
; 0000 0037 
; 0000 0038 // Port E initialization
; 0000 0039 // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 003A DDRE=(0<<DDE7) | (0<<DDE6) | (0<<DDE5) | (0<<DDE4) | (0<<DDE3) | (0<<DDE2) | (0<<DDE1) | (0<<DDE0);
	OUT  0x2,R30
; 0000 003B // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=T
; 0000 003C PORTE=(0<<PORTE7) | (0<<PORTE6) | (0<<PORTE5) | (0<<PORTE4) | (0<<PORTE3) | (0<<PORTE2) | (0<<PORTE1) | (0<<PORTE0);
	OUT  0x3,R30
; 0000 003D 
; 0000 003E // Port F initialization
; 0000 003F // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 0040 DDRF=(0<<DDF7) | (0<<DDF6) | (0<<DDF5) | (0<<DDF4) | (0<<DDF3) | (0<<DDF2) | (0<<DDF1) | (0<<DDF0);
	STS  97,R30
; 0000 0041 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=T
; 0000 0042 PORTF=(0<<PORTF7) | (0<<PORTF6) | (0<<PORTF5) | (0<<PORTF4) | (0<<PORTF3) | (0<<PORTF2) | (0<<PORTF1) | (0<<PORTF0);
	STS  98,R30
; 0000 0043 
; 0000 0044 // Port G initialization
; 0000 0045 // Function: Bit4=In Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 0046 DDRG=(0<<DDG4) | (0<<DDG3) | (0<<DDG2) | (0<<DDG1) | (0<<DDG0);
	STS  100,R30
; 0000 0047 // State: Bit4=T Bit3=T Bit2=T Bit1=T Bit0=T
; 0000 0048 PORTG=(0<<PORTG4) | (0<<PORTG3) | (0<<PORTG2) | (0<<PORTG1) | (0<<PORTG0);
	STS  101,R30
; 0000 0049 
...
; 0000 0057 // Mode: Fast PWM top=ICR1
; 0000 0058 // OC1A output: Non-Inverted PWM
; 0000 0059 // OC1B output: Disconnected
; 0000 005A // OC1C output: Disconnected
...
; 0000 0061 // Compare C Match Interrupt: Off
; 0000 0062 TCCR1A=(1<<COM1A1) | (0<<COM1A0) | (0<<COM1B1) | (0<<COM1B0) | (0<<COM1C1) | (0<<COM1C0) | (1<<WGM11) | (0<<WGM10);
	LDI  R30,LOW(130)
	OUT  0x2F,R30
; 0000 0063 TCCR1B=(0<<ICNC1) | (0<<ICES1) | (1<<WGM13) | (1<<WGM12) | (0<<CS12) | (0<<CS11) | (0<<CS10);
	LDI  R30,LOW(24)
	OUT  0x2E,R30
...
; 0000 0065 TCNT1L=0x00;
	OUT  0x2C,R30
; 0000 0066 ICR1H=0x4E;
	LDI  R30,LOW(78)
	OUT  0x27,R30
; 0000 0067 ICR1L=0x20;
	LDI  R30,LOW(32)
	OUT  0x26,R30
; 0000 0068 OCR1AH=0x27;
	LDI  R30,LOW(39)
	OUT  0x2B,R30
; 0000 0069 OCR1AL=0x10;
	LDI  R30,LOW(16)
	OUT  0x2A,R30
...
; 0000 006B OCR1BL=0x00;
	OUT  0x28,R30
; 0000 006C OCR1CH=0x00;
	STS  121,R30
; 0000 006D OCR1CL=0x00;
	STS  120,R30
; 0000 006E 
...
; 0000 0076 OCR2=0x00;
	OUT  0x23,R30
; 0000 0077 
; 0000 0078 // Timer/Counter 3 initialization
; 0000 0079 // Clock source: System Clock
; 0000 007A // Clock value: Timer3 Stopped
; 0000 007B // Mode: Normal top=0xFFFF
; 0000 007C // OC3A output: Disconnected
; 0000 007D // OC3B output: Disconnected
; 0000 007E // OC3C output: Disconnected
; 0000 007F // Noise Canceler: Off
; 0000 0080 // Input Capture on Falling Edge
; 0000 0081 // Timer3 Overflow Interrupt: Off
...
; 0000 0086 TCCR3A=(0<<COM3A1) | (0<<COM3A0) | (0<<COM3B1) | (0<<COM3B0) | (0<<COM3C1) | (0<<COM3C0) | (0<<WGM31) | (0<<WGM30);
	STS  139,R30
; 0000 0087 TCCR3B=(0<<ICNC3) | (0<<ICES3) | (0<<WGM33) | (0<<WGM32) | (0<<CS32) | (0<<CS31) | (0<<CS30);
	STS  138,R30
...
; 0000 008F OCR3BL=0x00;
	STS  132,R30
; 0000 0090 OCR3CH=0x00;
	STS  131,R30
; 0000 0091 OCR3CL=0x00;
	STS  130,R30
; 0000 0092 
...
; 0000 0094 TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (0<<OCIE0) | (0<<TOIE0);
	OUT  0x37,R30
; 0000 0095 ETIMSK=(0<<TICIE3) | (0<<OCIE3A) | (0<<OCIE3B) | (0<<TOIE3) | (0<<OCIE3C) | (0<<OCIE1C);
	STS  125,R30
; 0000 0096 
...
; 0000 009E // INT6: Off
; 0000 009F // INT7: Off
; 0000 00A0 EICRA=(0<<ISC31) | (0<<ISC30) | (0<<ISC21) | (0<<ISC20) | (0<<ISC11) | (0<<ISC10) | (0<<ISC01) | (0<<ISC00);
	STS  106,R30
; 0000 00A1 EICRB=(0<<ISC71) | (0<<ISC70) | (0<<ISC61) | (0<<ISC60) | (0<<ISC51) | (0<<ISC50) | (0<<ISC41) | (0<<ISC40);
	OUT  0x3A,R30
; 0000 00A2 EIMSK=(0<<INT7) | (0<<INT6) | (0<<INT5) | (0<<INT4) | (0<<INT3) | (0<<INT2) | (0<<INT1) | (0<<INT0);
	OUT  0x39,R30
; 0000 00A3 
